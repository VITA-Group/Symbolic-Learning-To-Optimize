...
def sr_fun_tensor(input_b_tf, coeff_SR, SR_memlen, Ngf, expr_Nvar, expr='', coeff_SRNorm=None, **w):
...
def genEmpExp_April(expr_vname_list, expr_memlen, expr_maxOrd, expr_group_len, **w):
